...
An async kernel for JupyterLite.
...
```bash
pip uninstall jupyterlite-async-kernel
```
...
folder is located. Then you can remove the symlink named `@jupyterlite/async-kernel` within that folder.
